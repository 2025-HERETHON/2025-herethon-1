...
urlpatterns = [
    ...
    path('<int:post_id>/comment/create/<int:now>/', views.detail_comment_create, name='detail_comment_create'),
    ...
    path('<int:post_id>/vote/<int:now>/', views.detail_vote, name='detail_vote'),
    path('<int:post_id>/comment/evidence/<int:now>', views.detail_comment_ai_response, name='detail_comment_ai_response'),
